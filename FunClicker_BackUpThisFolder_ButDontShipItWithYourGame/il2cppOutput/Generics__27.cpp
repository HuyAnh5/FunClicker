...
IL_0009:
	...
	try
	{
		...
		try
		{
			uint32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_Add_mFA24AB9B306F29FE7C78B0BF521DE0D2ECC77CF6(__this, L_3, ((*(MarkToBaseAdjustmentRecord_t03C041CB56601B46F025C69B899BBAB750201C71*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 16)))), il2cpp_rgctx_method(method->klass->rgctx_data, 22));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL_0009:
	...
	try
	{
		...
		try
		{
			uint32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_Add_m3EAC3723FEE3DBD25B2E22298D0A676E28E4A89B(__this, L_3, ((*(WorldSpaceData_t1F653E7DB8EA00BA1A22EC93964627BCB938E922*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 16)))), il2cpp_rgctx_method(method->klass->rgctx_data, 22));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
